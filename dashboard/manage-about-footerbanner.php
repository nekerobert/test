						...
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<div class="page-breadcrumb">
									<h1>Manage About Footer Banner</h1>
								</div>
							</div>
									...
									<div class="card  border-info lobicard-custom-control lobi-light  mb-4">
										<div class="card-header bg-info ">
											<div class="card-title text-white">
												Manage About Footer Banner
											</div>
										</div>
								<div class="card-body">
									<form id="signupForm1" method="post" class=" right-text-label-form feedback-icon-form" action="#" novalidate="novalidate">
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="servetitle">Banner Title:</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="servetitle" name="servetitle" placeholder="Service Title">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="bannerbtn">Banner Button Title:</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="" name="bannerbtn" placeholder="Banner Button Title">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="bannerbtnlink">Banner Button Link:</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="" name="bannerbtnlink" placeholder="Banner Button Link">
											</div>
										</div>
										<div class="form-group row">
