								...
								<div class="card-body">
									<form id="signupForm1" method="post" class=" right-text-label-form feedback-icon-form" action="#" novalidate="novalidate">
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="servetitle">Contact Section Title:</label>
											<div class="col-sm-5">
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												<textarea class="form-control" id="editor" name="servedesc" placeholder="Service Description"></textarea>
											</div>
										</div>
										<div class="form-group row">
