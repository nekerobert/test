				...
				<ul id="dc_accordion" class="sidebar-menu tree">
					...
					<li class="menu_sub">
						...
						<a href="#" class="dcjq-parent active"> <i class="fa fa-wpforms"></i> <span>Home Slider</span> <span class="arrow"></span> <span class="dcjq-icon"></span></a>
							...
							<!-- <li>
							<a href="manage-home-equipment.php"><i class="fa fa-tasks"></i>Home Equipment Section</a>
						</li> -->
                    </ul>
                </li>
...
<!--FAQ page starts-->
                    <li class="menu_sub">
						<a href="#"> <i class="fa fa-envelope-o"></i> <span>Contact Us</span> <span class="arrow"></span> </a>
						<ul class="down_menu">
										<li>
											<a href="manage-contact-section.php"><i class="fa fa-tasks"></i> Contact Section</a>
										</li>
										<li>
											<a href="manage-contact-details.php"><i class="fa fa-tasks"></i>Contact Details</a>
										</li>
										<li>
											<a href="manage-usercontact.php"><i class="fa fa-tasks"></i> User Contact</a>
										</li>
                                    </ul>
                                </li>
<!--FAQ page stops-->
...
<!--News page starts-->
                    <li class="menu_sub">
						...
						<ul class="down_menu">
									<li>
										<a href="add-news.php"><i class="fa fa-plus-square"></i>Add News</a>
									</li>
										<li>
